export default {
  ...
  tagline: 'Би тод, санах ойд үлдэх дижитал туршлагууд бүтээдэг.',
  ...
  {
    category: 'Backend',
    items: ['Node.js', 'PostgreSQL', 'MongoDB', 'Redis', 'GraphQL', 'REST API']
  },
  {
    category: 'Хэрэгсэл',
  ...
  whyMeLead: 'Технологиос цааш — би хэрхэн ажилладаг, багт юу авчрах вэ, харилцагч яагаад буцаж ирдэг талаар.',
  whyMe: [
  {
    title: 'Би нарийвчлалыг чухалчилдаг',
    description:
      'Цэвэр архитектур, анхааралтай UX, засварлахад хялбар код. Жижиг зүйлс дээр анхаардаг тул бүтээгдэхүүн эхнээсээ дуустал гоё мэдрэгддэг.'
  },
  {
    title: 'Би хариуцлага хүлээдэг',
    description:
      'Хүрээ тодорхойлохоос гаргах хүртэл заавар хүлээлгүй ажилдаа урагшилдаг. Асуудлыг задлан, эрт харилцаж, амласан зүйлээ биелүүлдэг.'
  },
  {
    title: 'Би дизайн, инженерчлэлийг холбодог',
    description:
      'Хоёр хэлээр ярьдаг — төгс интерфэйс, бат бөх backend. Ингэснээр гар дамжлагын зай багасаж, багтайгаа хурдан сайжруулдаг.'
  },
  {
    title: 'Би эхлээд гаргаад, дараа нь сайжруулдаг',
    description:
      'Чанарыг алдалгүй хурданд анхаардаг. Эхлээд зөв хувилбарыг гаргаж, чухал зүйлсийг хэмжиж, бодит санал дээр үндэслэн сайжруулдаг.'
  }
],
  faq: [
  {
  ...
  faqIntro: 'Холбогдохоос өмнөх түгээмэл асуултууд. Асуулт үлдсэн бол хэзээ ч бичээрэй.'
}
